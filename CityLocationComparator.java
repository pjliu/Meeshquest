...
/**
 * Compares two cities based on location of x, y and z coordinates. 
 * First compares the x values of each {@link City}. 
 * If the x values are the same, then the y values of each City are compared. 
 * If the y values are the same, then the z values of each City are compared.
 * 
 * @author Ben Zoller
